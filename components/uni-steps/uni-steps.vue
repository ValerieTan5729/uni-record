<template>
	<view class="uni-steps">
		<view :class="[direction==='column'?'uni-steps__column':'uni-steps__row']">
          ...
          <text v-if="myStyle === 1" :class="[direction==='column'?'uni-steps__column-title':'uni-steps__row-title']" style="font-size: 34rpx; font-weight: bold; margin-bottom: 10rpx; color: #007AFF;">{{item.title}}</text>
          <text v-else :style="{color:index<=active?activeColor:deactiveColor}" :class="[direction==='column'?'uni-steps__column-title':'uni-steps__row-title']">{{item.title}}</text>
          ...
          <view v-if="myStyle === 1">
            <text style="color: #007AFF; font-weight: bold;">{{ index + 1 }}</text>
          </view>
					<view v-else>
